...
* `url`: URL of castaway page on the history channel website. Prefix URL with https://www.history.com/shows/alone/cast
* `image_url`: URL of survivalist image from the history channel. Prefix URL with https://cropper.watch.aetnd.com/cdn.watch.aetnd.com/sites/2/
